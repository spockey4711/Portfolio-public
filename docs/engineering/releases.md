...
| ---------- | -------- | ---- | ----------------------------------------------------------------- |
| 2026-09-18 | v0.5.0 | #19 | Promotes the compact projects band, the masthead hero, the /projekte index list, the project screenshots section, the boot-overlay removal and the React 19.3 / Playwright 1.63 / Changesets 3 bumps. |
