...
/**
 * Whether the hero's availability pill ("Verfügbar als Werkstudent") is rendered.
 ...
 * pill is simply absent from the prerendered HTML when the flag is unset. Reads the
